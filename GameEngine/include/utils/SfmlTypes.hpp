...
namespace GameEngine
{
    ...
    static const std::unordered_map<Input::Keyboard::Key, sf::Keyboard::Key> sfKeys = {
        ...
        static bool isKeyPressed(const Input::Keyboard::Key key) { return sf::Keyboard::isKeyPressed(sfKeys.at(key)) /* TO UPDATE*/};
        static bool isKeyreleased(const Input::Keyboard::Key key) { /* TODO */ };
        static bool isKeystillpressed(const Input::Keyboard::Key) { /* TODO */ };
      private:
        int is_pressed
    }
