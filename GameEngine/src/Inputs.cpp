...
const std::unordered_map<GameEngine::Input::Keyboard::Key, sf::Keyboard::Key> GameEngine::InputManager::sfKeys = {
    ...
    {Input::Keyboard::Key::Subtract, sf::Keyboard::Subtract}, {Input::Keyboard::Key::Multiply, sf::Keyboard::Multiply},
    {Input::Keyboard::Key::Divide, sf::Keyboard::Divide}, {Input::Keyboard::Key::Left, sf::Keyboard::Left},
    {Input::Keyboard::Key::Right, sf::Keyboard::Right}, {Input::Keyboard::Key::Up, sf::Keyboard::Up},
    {Input::Keyboard::Key::Down, sf::Keyboard::Down}, {Input::Keyboard::Key::Numpad0, sf::Keyboard::Numpad0},
    {Input::Keyboard::Key::Numpad1, sf::Keyboard::Numpad1}, {Input::Keyboard::Key::Numpad2, sf::Keyboard::Numpad2},
    {Input::Keyboard::Key::Numpad3, sf::Keyboard::Numpad3}, {Input::Keyboard::Key::Numpad4, sf::Keyboard::Numpad4},
    {Input::Keyboard::Key::Numpad5, sf::Keyboard::Numpad5}, {Input::Keyboard::Key::Numpad6, sf::Keyboard::Numpad6},
    {Input::Keyboard::Key::Numpad7, sf::Keyboard::Numpad7}, {Input::Keyboard::Key::Numpad8, sf::Keyboard::Numpad8},
    {Input::Keyboard::Key::Numpad9, sf::Keyboard::Numpad9}, {Input::Keyboard::Key::F1, sf::Keyboard::F1},
    {Input::Keyboard::Key::F2, sf::Keyboard::F2}, {Input::Keyboard::Key::F3, sf::Keyboard::F3},
    {Input::Keyboard::Key::F4, sf::Keyboard::F4}, {Input::Keyboard::Key::F5, sf::Keyboard::F5},
    {Input::Keyboard::Key::F6, sf::Keyboard::F6}, {Input::Keyboard::Key::F7, sf::Keyboard::F7},
    {Input::Keyboard::Key::F8, sf::Keyboard::F8}, {Input::Keyboard::Key::F9, sf::Keyboard::F9},
    {Input::Keyboard::Key::F10, sf::Keyboard::F10}, {Input::Keyboard::Key::F11, sf::Keyboard::F11},
    {Input::Keyboard::Key::F12, sf::Keyboard::F12}, {Input::Keyboard::Key::F13, sf::Keyboard::F13},
    {Input::Keyboard::Key::F14, sf::Keyboard::F14}, {Input::Keyboard::Key::F15, sf::Keyboard::F15},
