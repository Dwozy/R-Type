...
target_include_directories(${CLIENT_BINARY_NAME} PRIVATE ${INCLUDES_CLIENT} ${INCLUDES_GLOBAL} ${CMAKE_SOURCE_DIR}/GameEngine/include/ ${lua_SOURCE_DIR}/src)
...
target_link_libraries(${CLIENT_BINARY_NAME} PRIVATE lua::lua)
target_link_libraries(${CLIENT_BINARY_NAME} PRIVATE sol2)
