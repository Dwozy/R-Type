...
class MenuScene : public GameEngine::IScene
{
  public:
    ...
    void load()
    {
        ...
        _gameEngine.registry.addComponent<GameEngine::PositionComponent>(
  ...
  public:
    ...
    void load()
    {
        ...
        col.addAction<std::function<void(const std::size_t &, SparseArray<GameEngine::CollisionComponent> &,
            ...
            _gameEngine.registry, test);

        _gameEngine.registry.addComponent<GameEngine::PositionComponent>(player, pos);
        _gameEngine.registry.addComponent<GameEngine::VelocityComponent>(player, vel);
