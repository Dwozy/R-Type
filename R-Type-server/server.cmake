...
target_include_directories(${SERVER_BINARY_NAME} PRIVATE ${INCLUDES_SERVER} ${INCLUDES_GLOBAL} ${CMAKE_SOURCE_DIR}/GameEngine/include/ ${lua_SOURCE_DIR}/src)
...
target_link_libraries(${SERVER_BINARY_NAME} PRIVATE lua::lua)
target_link_libraries(${SERVER_BINARY_NAME} PRIVATE sol2)
