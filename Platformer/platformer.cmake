...
if (DEFINED INSTALL)
    ...
    install(DIRECTORY ${GAME_FOLDER}/assets/ DESTINATION bin/${GAME_FOLDER}/assets)
    install(DIRECTORY ${GAME_FOLDER}/maps/ DESTINATION bin/${GAME_FOLDER}/maps)
    install(DIRECTORY ${GAME_FOLDER}/config/ DESTINATION bin/${GAME_FOLDER}/config)
